...
public class SimpleSpringWebMvcConfig extends WebMvcConfigurerAdapter {
	...
	public void addFormatters(FormatterRegistry registry) {
		...
		registry.addConverter(converters.getStringToEmployeeConverter((ConversionService) registry));
		registry.addConverter(converters.getStringToHolidayRequestConverter((ConversionService) registry));
